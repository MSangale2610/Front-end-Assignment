  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <Link className="nav-link active" to="/about"><b>About Us</b></Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link active" to="/about">Contact Us</Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link" to="#"><b>{props.contact}</b></Link>
        </li>
...
Navbar.propTypes={title: PropTypes.string,contact:PropTypes.string};
Navbar.defaultProps={
